        ...
        for (const badge of catBadges) {
            ...
            html += `
                <div class="badge-card ${earned ? 'earned' : 'locked'}">
                    <div class="badge-icon ${tierClass}" ${themeStyle || ''}>
                    ...
                    <div class="badge-info">
                        ...
                        <div class="badge-progress">
                            <div class="badge-progress-bar">
                                <div class="badge-progress-fill ${fillClass}" style="width: ${progressPct}%;${badge.colors && earned ? ` background: ${badge.colors.bg}; box-shadow: 0 0 4px ${badge.colors.bg}40;` : ''}"></div>
                            </div>
                            ${earned
